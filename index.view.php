...
<div class="clinics">
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-4 wow slideInLeft">
            <div class="clinic">
        ...
        <div class="col-sm-6 col-lg-4 wow slideInDown">
            <div class="clinic">
                <div class="clinic-img"><img src="public/images/clinics/teeth.jpg"></div>
                <div class="clinic-name">Dentist Clinic</div>
                <div class="clinic-btn text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-7 text-center">
                        <div class="doctor-name">
                            <h4>Dentist Clinic</h4>
                            <p class="doctor_specialize">Dentist</p>
                        </div>
